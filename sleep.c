...
//                his_data[HIS_DSG_UVP_ADD] = 1;              // 20190521  AID
                his_data[HIS_DSG_UVP_ADD] |= 0x01;          //20190912 fenglong 为追查无故进SHIPPING增加的代码
            }
            else
            {
//                his_data[HIS_DSG_UVP_ADD] = 0;              // 20190521  AID
                his_data[HIS_DSG_UVP_ADD] &= 0xFE;          //20190912 fenglong 为追查无故进SHIPPING增加的代码
            }
